...
<body>
    ...
    <div class="container">
        <div class="jumbotron text-dark my-5" style="background-color:rgb(199, 199, 199); padding:50px;">
            <h2 class="display-4 text-center" style="font-weight:normal; margin-bottom: 17px; padding-bottom:12px;">
                <?php echo $thread_title; ?>
            </h2>
            <p class="lead text-dark" style="font-size:24px; font-weight:normal;">
                <?php echo $thread_desc; ?>
            </p>
            <hr class="my-4">
            <p style="font-size:18px;">No Spam / Advertising / Self-promote in the forums is not allowed. Do not
                postcopyright-infringing material. Do not post “offensive” posts, links or images. Do not cross post
        ...
        if ($row2 && isset($row2['user_name'])) {
            ...
            echo '<div class="d-flex align-items-center my-4">
                    <div class="flex-shrink-0">
                        <img src="data:image/jpeg;base64, ' . $user_image_base64 . '" width="60px" alt="User DP">
                    </div>
